...
const BlogDetailsPage = () => {
  return (
    <div class="relative pb-16 overflow-hidden">
      {/* top image & Date */}
      <div className="lg:grid lg:grid-cols-4 lg:gap-6 space-y-10 lg:space-y-0">
        <div className="lg:col-span-2 lg:order-2">
          <div className="aspect-video">
            <img
              src="https://www.angularminds.com/angular-minds-admin/uploads/blog_images/945ccf23249068fa950a007d441004e0.png"
              alt=""
              className="h-full w-full object-cover object-center"
            />
          </div>
        </div>
        <div className="lg:col-span-2 lg:order-1 mt-auto flex gap-3 items-end lg:justify-end px-4 border-b border-neutral-800 pb-4">
          <span className="md:w-7 md:h-7 w-6 h-6 border border-neutral-800 rounded-full"></span>
          <time className="md:text-3xl text-xl font-light" dateTime="2020-01-01">
            January 1, 2020
          </time>
        </div>
      </div>
      {/* Title */}
      <div className='px-4 sm:px-6 mb-14 mt-4'>
        <h1 className='md:text-5xl text-3xl font-bold tracking-wide max-w-6xl uppercase !leading-[1.36]'>
          React version 18 is out and it's awesome! Great features! full
          explanation - React 18
        </h1>
      </div>
      <div class="relative px-4 sm:px-6 lg:px-8">
        <div class="text-lg max-w-prose mx-auto">
          ...
          <p class="first-letter:text-5xl mt-8 text-xl leading-8">
